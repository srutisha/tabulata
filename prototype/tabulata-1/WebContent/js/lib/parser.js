	  ...
	  var result = {
	    ...
	    parse: function(input, startRule) {
	      ...
	      function parse_additive() {
	        ...
	        var savedPos2 = pos;
	        var savedPos3 = pos;
	        var result11 = parse_multiplicative();
	        if (result11 !== null) {
	          if (input.substr(pos, 1) === "+") {
	            var result12 = "+";
	            pos += 1;
	      ...
	      function parse_primary() {
	        ...
	        var result22 = result21 !== null
	          ? (function(nb) { return nb; })(result21[1])
	          : null;
	        if (result22 !== null) {
	      ...
	      function parse_number() {
	        ...
	        var result2 = result1 !== null
	          ? (function(sg, n1, pt, n2) { return flatten([sg,n1,pt,n2]); })(result1[0], result1[1], result1[2], result1[3])
	          : null;
	        if (result2 !== null) {
	          var result0 = result2;
	        } else {
